...
export const en = {
  ...
  home: {
    ...
    fallbackTitle: 'The Icelandic Web Industry Association',
    joinCta: 'Become a member',
    eventsCta: 'See events',
    happeningNow: 'Happening now',
    visitSite: 'Visit the site',
    aboutAwards: 'About the awards',
    eventsTitle: 'Upcoming events',
    allEvents: 'All events',
    winnersTitle: 'Award-winning sites',
    winnersEmpty: {
      title: 'No winners recorded yet',
      body: 'Award-winning sites from past years appear here once the archive has been imported.',
    },
    photosTitle: 'Photos from events',
    allPhotos: 'All photos',
    enlargePhoto: 'Enlarge photo',
    photosEmpty: {
      title: 'No photos yet',
      body: 'Photos from SVEF events appear here as soon as they arrive.',
    },
  },
  events: {
    title: 'Events',
